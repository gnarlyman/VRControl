...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_vrcontrol p_vrcontrol;
        ...
        public static SteamVR_Input_ActionSet_vrcontrol vrcontrol
        {
            get
            {
                return SteamVR_Actions.p_vrcontrol.GetCopy<SteamVR_Input_ActionSet_vrcontrol>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_vrcontrol = ((SteamVR_Input_ActionSet_vrcontrol)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_vrcontrol>("/actions/vrcontrol")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.vrcontrol};
        }
    }
}
